...
export declare function generateServiceSpecs<S extends m.Service<any, any>, M extends m.Method<any>, E extends m.Event<any>>(modules: s.Map<s.Module>, isService?: (decorator: s.Decorator<s.ClassConstructor>) => boolean, onService?: (service: S, classConstructor: s.ClassConstructor) => void, onMethod?: (method: M, member: s.ClassConstructorMember) => M, onEvent?: (event: E, member: s.ClassConstructorMember) => E, visitor?: v.ServicesVisitor<S, M, E>): m.Services<S>;
